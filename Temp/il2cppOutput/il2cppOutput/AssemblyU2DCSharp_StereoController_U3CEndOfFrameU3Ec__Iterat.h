...
struct  U3CEndOfFrameU3Ec__Iterator0_t7_40  : public Object_t
{
	...
	// StereoController StereoController/<EndOfFrame>c__Iterator0::<>f__this
	StereoController_t7_21 * ___U3CU3Ef__this_2;
};

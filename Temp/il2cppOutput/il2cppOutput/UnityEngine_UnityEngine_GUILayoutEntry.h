...
struct  GUILayoutEntry_t5_198  : public Object_t
{
	...
	GUIStyle_t5_41 * ___m_Style_7;
};
struct GUILayoutEntry_t5_198_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t5_32  ___kDummyRect_8;
